...
import { Loader2, Eye, EyeOff, AppleIcon, ChevronDown } from "lucide-react";
            ...
            <Form {...form}>
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <button
                    type="button"
                    className="w-full h-12 border border-white rounded-full flex items-center justify-center space-x-3 hover:bg-gray-50 transition-colors mb-10"
                    onClick={() =>
